 ...
 * @property integer $id_metodo_de_pago
 * @property integer $id_tipo_de_contenido
...
class ProductosDigitales extends CActiveRecord implements IECartPosition
{
	...
	public function rules()
	{
		...
		return array(
			array('id_producto, descripcion, id_categoria, id_metodo_de_pago, id_tipo_de_contenido', 'required'),
			array('id_categoria, id_metodo_de_pago, id_tipo_de_contenido', 'numerical', 'integerOnly'=>true),
			array('precio', 'numerical'),
			array('id_producto', 'length', 'max'=>250),
			array('descripcion', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idproductos_digitales, id_producto, descripcion, id_categoria, id_metodo_de_pago, id_tipo_de_contenido, precio', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_metodo_de_pago' => 'Id Metodo De Pago',
			'id_tipo_de_contenido' => 'Id Tipo De Contenido',
			'precio' => 'Precio',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_metodo_de_pago',$this->id_metodo_de_pago);
		$criteria->compare('id_tipo_de_contenido',$this->id_tipo_de_contenido);
